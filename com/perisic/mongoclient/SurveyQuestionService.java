...
public class SurveyQuestionService {
    ...
    public void addToQuestionPane(ArrayList<String> questions, List<String[]> options, ArrayList<String> optionCode) {
        try {
    ...
    public ArrayList<Document> getBasicQuestions() {
        ...
        try {
            ...
            for (org.bson.Document a : cus.collation(null)) {
                questionDoc.add(new Document("Question", a.get("description")).append("Answer_Type", a.get("ques_type_code")).append("Answer", a.get("ques_type")));
            }
            return questionDoc;
